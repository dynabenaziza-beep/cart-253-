...
//rectangle wall background
//  ROW 1 
fill(200,220,255); rect(0,0,280,180);
fill(255,200,200); rect(200,0,150,180);
fill(255,200,150); rect(350,0,340,180);
fill(180,220,180); rect(650,0,250,180);

//row 2 
fill(220,140,40); rect(0,200,180,170);
fill(210,160,255); rect(560,180,220,170);
fill(255,170,130); rect(700,180,250,170);
fill(160,210,250); rect(650,400,250,270) 
//row3 
fill(255,220,180); rect(0,350,240,190);
fill(200,255,200); rect(240,360,210,180);
fill(255,120,120); rect(450,345,220,200);
fill(250,150,100); rect(670,350,230,190); 
//row 4 
fill(100,150,220); rect(0,540,200,200);
fill(180,120,80);  rect(300,550,260,180);
fill(240,240,240);  rect(400,545,210,190);
fill(255,120,120);  rect(700,540,230,200);
//row 5 
fill(255,200,200);  rect(0,730,310,170);
fill(255,240,150);  rect(310,720,290,180);
fill(180,220,180);  rect(600,740,300,160);
